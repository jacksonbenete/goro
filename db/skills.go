...
var SkillEffects = map[uint16]SkillEffectSpec{
	...
	SkillKNSpearboomerang:           {EffectIDsOnCaster: []int{effectSpearBmrSelf}, HitEffectIDs: []int{80, effectHit4}},
	...
	SkillPRMagnus:                   {EffectIDs: []int{113}, GroundEffectIDs: []int{318}, HitEffectIDs: []int{effectHolyLight}},
