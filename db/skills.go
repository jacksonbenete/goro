...
var SkillEffects = map[uint16]SkillEffectSpec{
	...
	SkillKNSpearstab:                {EffectIDsOnCaster: []int{150}},
	SkillKNSpearboomerang:           {EffectIDsOnCaster: []int{151}, HitEffectIDs: []int{80, effectHit4}},
	SkillKNTwohandquicken:           {EffectIDs: []int{130}},
	...
	SkillPRSanctuary:                {EffectIDs: []int{83}, GroundEffectIDs: []int{319}},
	SkillPRSlowpoison:               {EffectIDs: []int{136}},
	SkillPRStrecovery:               {EffectIDs: []int{78}},
	SkillPRKyrie:                    {EffectIDs: []int{112}},
	SkillPRMagnificat:               {EffectIDs: []int{76}},
	SkillPRGloria:                   {EffectIDs: []int{75}},
	SkillPRLexdivina:                {EffectIDs: []int{87}},
	SkillPRTurnundead:               {HitEffectIDs: []int{152}},
	SkillPRLexaeterna:               {EffectIDs: []int{85}},
	SkillPRMagnus:                   {EffectIDs: []int{113}, GroundEffectIDs: []int{318}, HitEffectIDs: []int{152}},
	...
	SkillMCCartrevolution:           {HitEffectIDs: []int{170}, BeginCastEffectIDs: []int{170}},
	SkillMCLoud:                     {EffectIDs: []int{311}},
	...
	SkillNPCHolyattack:              {HitEffectIDs: []int{152}},
	SkillNPCDarknessattack:          {EffectIDs: []int{184}, HitEffectIDs: []int{180}},
	SkillNPCTelekinesisattack:       {EffectIDs: []int{198}},
	SkillNPCMagicalattack:           {HitEffectIDs: []int{182}},
	SkillNPCProvocation:             {SuccessEffectIDs: []int{67}},
	SkillNPCBlooddrain:              {EffectIDsOnCaster: []int{216}},
	SkillNPCEnergydrain:             {EffectIDsOnCaster: []int{217}},
	SkillNPCKeeping:                 {EffectIDs: []int{214}},
	SkillNPCDarkbreath:              {EffectIDs: []int{212}},
	SkillNPCDefender:                {EffectIDs: []int{213}},
	SkillRGStealcoin:                {SuccessEffectIDs: []int{268, 274}},
	SkillRGBackstap:                 {HitEffectIDs: []int{275}},
	SkillRGRaid:                     {EffectIDsOnCaster: []int{276}},
	SkillRGStripweapon:              {SuccessEffectIDs: []int{269}},
	SkillRGStripshield:              {SuccessEffectIDs: []int{270}},
	SkillRGStriparmor:               {SuccessEffectIDs: []int{271}},
	SkillRGStriphelm:                {SuccessEffectIDs: []int{272}},
	SkillRGIntimidate:               {EffectIDs: []int{227}},
	SkillAMDemonstration:            {GroundEffectIDs: []int{302}},
	SkillAMAcidterror:               {BeforeHitEffectIDs: []int{298}},
	SkillAMPotionpitcher:            {EffectIDs: []int{299}},
	SkillAMCpWeapon:                 {EffectIDs: []int{300}},
	SkillAMCpShield:                 {EffectIDs: []int{300}},
	SkillAMCpArmor:                  {EffectIDs: []int{300}},
	SkillAMCpHelm:                   {EffectIDs: []int{300}},
	SkillCRAutoguard:                {EffectIDs: []int{336}},
	SkillCRShieldcharge:             {EffectIDs: []int{246}},
	SkillCRShieldboomerang:          {EffectIDs: []int{249}},
	SkillCRReflectshield:            {EffectIDs: []int{252}},
	SkillCRHolycross:                {EffectIDs: []int{245}},
	SkillCRGrandcross:               {EffectIDs: []int{226}},
	SkillCRDevotion:                 {EffectIDs: []int{251}},
	SkillCRProvidence:               {EffectIDs: []int{248}},
	SkillCRDefender:                 {EffectIDs: []int{222}},
	SkillCRSpearquicken:             {EffectIDs: []int{250}},
	SkillMOAbsorbspirits:            {SuccessEffectIDsSelf: []int{253}},
	SkillMOTripleattack:             {EffectIDs: []int{329}},
	SkillMOInvestigate:              {EffectIDs: []int{267}},
	SkillMOFingeroffensive:          {EffectIDs: []int{265}, HitEffectIDs: []int{1}},
	SkillMOSteelbody:                {EffectIDs: []int{254}},
	SkillMOExplosionspirits:         {EffectIDsOnCaster: []int{261}, BeginCastEffectIDs: []int{12}},
	SkillMOExtremityfist:            {HitEffectIDs: []int{266}, BeginCastEffectIDs: []int{12}},
	SkillMOChaincombo:               {EffectIDs: []int{262, 273}, EffectIDsOnCaster: []int{263}},
	SkillMOCombofinish:              {EffectIDs: []int{330}},
	SkillSAMagicrod:                 {SuccessEffectIDs: []int{244}},
	SkillSASpellbreaker:             {SuccessEffectIDs: []int{234}},
	SkillSAFlamelauncher:            {SuccessEffectIDs: []int{255}},
	SkillSAFrostweapon:              {SuccessEffectIDs: []int{256}},
	SkillSALightningloader:          {SuccessEffectIDs: []int{257}},
	SkillSASeismicweapon:            {SuccessEffectIDs: []int{258}},
	SkillSAVolcano:                  {EffectIDsOnCaster: []int{225}, GroundEffectIDs: []int{239}},
	SkillSADeluge:                   {EffectIDsOnCaster: []int{236}, GroundEffectIDs: []int{240}},
	SkillSAViolentgale:              {EffectIDsOnCaster: []int{237}, GroundEffectIDs: []int{241}},
	SkillSALandprotector:            {EffectIDsOnCaster: []int{238}, GroundEffectIDs: []int{242}},
	SkillSADispell:                  {SuccessEffectIDs: []int{235}},
	SkillBDLullaby:                  {EffectIDs: []int{278}},
	SkillBDRichmankim:               {EffectIDs: []int{279}},
	SkillBDEternalchaos:             {EffectIDs: []int{280}},
	SkillBDDrumbattlefield:          {EffectIDs: []int{281}},
	SkillBDRingnibelungen:           {EffectIDs: []int{282}},
	SkillBDRokisweil:                {EffectIDs: []int{283}},
	SkillBDIntoabyss:                {EffectIDs: []int{284}},
	SkillBDSiegfried:                {EffectIDs: []int{285}},
	SkillBaMusicalstrike:            {HideCastAura: true},
	SkillBaFrostjoke:                {BeginCastEffectIDs: []int{295}},
	SkillBaWhistle:                  {EffectIDs: []int{286}},
	SkillBaAssassincross:            {EffectIDs: []int{287}},
	SkillBaPoembragi:                {EffectIDs: []int{288}},
	SkillBaAppleidun:                {EffectIDs: []int{289}},
	SkillDCThrowarrow:               {HideCastAura: true},
	SkillDCScream:                   {BeginCastEffectIDs: []int{296}},
	SkillDCHumming:                  {EffectIDs: []int{291}},
	SkillDCDontforgetme:             {EffectIDs: []int{292}},
	SkillDCFortunekiss:              {EffectIDs: []int{293}},
	SkillDCServiceforyou:            {EffectIDs: []int{294}},
	SkillITMTomahawk:                {EffectIDs: []int{494}},
	SkillNPCDarkcross:               {EffectIDs: []int{450}},
	SkillNPCDarkstrike:              {EffectIDs: []int{451}},
	SkillNPCDarkthunder:             {EffectIDs: []int{93}, HitEffectIDs: []int{94}},
	SkillNPCStop:                    {EffectIDs: []int{453}},
	SkillNPCPowerup:                 {EffectIDs: []int{456}},
	SkillLKAurablade:                {EffectIDs: []int{367}},
	SkillLKParrying:                 {EffectIDs: []int{336}},
	SkillLKConcentration:            {EffectIDs: []int{369}},
	SkillLKBerserk:                  {EffectIDs: []int{368}},
	SkillLKFury:                     {EffectIDs: []int{368}},
	SkillHPAssumptio:                {EffectIDs: []int{440}},
	SkillHPBasilica:                 {GroundEffectIDs: []int{374}},
	SkillHWMagiccrasher:             {EffectIDs: []int{380}},
	SkillHWMagicpower:               {BeginCastEffectIDs: []int{16}, HideCastAura: true},
	SkillHWSouldrain:                {EffectIDsOnCaster: []int{217}},
	SkillPaPressure:                 {BeforeHitEffectIDs: []int{365}},
	SkillPaSacrifice:                {EffectIDs: []int{366}},
	SkillPaGospel:                   {EffectIDs: []int{370}},
	SkillChPalmstrike:               {HitEffectIDs: []int{376}},
	SkillChTigerfist:                {EffectIDs: []int{377}, EffectIDsOnCaster: []int{263}},
	SkillChChaincrush:               {EffectIDs: []int{512}},
	SkillPFHpconversion:             {EffectIDs: []int{383}, EffectIDsOnCaster: []int{378}, SuccessEffectIDsSelf: []int{379}},
	SkillPFSoulchange:               {EffectIDs: []int{384}, SuccessEffectIDs: []int{385}},
	SkillPFSoulburn:                 {EffectIDs: []int{406}},
	SkillASCEdp:                     {EffectIDs: []int{493}},
	SkillASCBreaker:                 {BeforeHitEffectIDs: []int{361}},
	SkillSNSight:                    {EffectIDs: []int{386}},
	SkillSNFalconassault:            {EffectIDs: []int{387}, HideCastAura: true},
	SkillSNSharpshooting:            {HitEffectIDs: []int{388}},
	SkillSNWindwalk:                 {EffectIDs: []int{389}},
	SkillWSMeltdown:                 {EffectIDs: []int{390}},
	SkillWSCartboost:                {EffectIDs: []int{391}},
	SkillSTChasewalk:                {BeginCastEffectIDs: []int{501}},
	SkillSTRejectsword:              {EffectIDs: []int{392}},
	SkillCGArrowvulcan:              {EffectIDs: []int{393}},
	SkillCGMoonlit:                  {EffectIDs: []int{394}},
	SkillCGMarionette:               {EffectIDs: []int{395}, HitEffectIDs: []int{396}},
	SkillLKSpiralpierce:             {EffectIDs: []int{339}, HideCastAura: true},
	SkillLKHeadcrush:                {BeginCastEffectIDs: []int{399}},
	SkillLKJointbeat:                {BeginCastEffectIDs: []int{400}},
	...
	SkillTKJumpkick:                 {EffectIDs: []int{439}, HitEffectIDs: []int{457}},
	...
	SkillAMBerserkpitcher:           {EffectIDs: []int{220}, BeforeHitEffectIDs: []int{541}},
	SkillSLBlacksmith:               {EffectIDs: []int{424, 503}},
	SkillSLSoullinker:               {EffectIDs: []int{424, 503}},
	SkillSLKaizel:                   {EffectIDs: []int{590}},
	SkillSLKaahi:                    {EffectIDs: []int{543}},
	SkillSLKaupe:                    {EffectIDs: []int{546}},
	SkillSLKaite:                    {EffectIDs: []int{419}},
	SkillSLStin:                     {EffectIDs: []int{547}},
	SkillSLStun:                     {EffectIDs: []int{555}},
	SkillSLSma:                      {EffectIDs: []int{553}, SuccessEffectIDs: []int{425}},
	SkillSLSwoo:                     {EffectIDs: []int{589}, SuccessEffectIDs: []int{420}},
	SkillSLSke:                      {EffectIDs: []int{427}},
	SkillSLSka:                      {EffectIDs: []int{254, 261}},
	SkillSTPreserve:                 {EffectIDs: []int{496}},
	SkillSTFullstrip:                {SuccessEffectIDs: []int{495}},
	SkillCRFullprotection:           {EffectIDs: []int{300, 500}},
	...
	SkillCGHermode:                  {GroundEffectIDs: []int{517}},
	SkillCGTarotcard:                {SuccessEffectIDs: []int{500}},
	SkillCRAciddemonstration:        {EffectIDs: []int{537}},
	...
	SkillGSTripleaction:             {EffectIDs: []int{648}},
	SkillGSBullseye:                 {EffectIDs: []int{649}},
	SkillGSMadnesscancel:            {EffectIDs: []int{625}},
	SkillGSAdjustment:               {EffectIDs: []int{626}},
	SkillGSIncreasing:               {EffectIDs: []int{456}},
	SkillGSMagicalbullet:            {EffectIDs: []int{644}},
	SkillGSTracking:                 {EffectIDs: []int{646}, HitEffectIDs: []int{647}},
	SkillGSDisarm:                   {EffectIDs: []int{627}},
	SkillGSRapidshower:              {EffectIDs: []int{643}},
	SkillGSDesperado:                {EffectIDs: []int{637}},
	SkillGSGatlingfever:             {EffectIDs: []int{626}},
	SkillGSDust:                     {EffectIDs: []int{628}},
	SkillGSFullbuster:               {EffectIDs: []int{584}},
	SkillGSSpreadattack:             {EffectIDs: []int{645}},
	SkillNJSyuriken:                 {BeforeHitEffectIDs: []int{613}},
	SkillNJKunai:                    {BeforeHitEffectIDs: []int{614}},
	SkillNJHuuma:                    {BeforeHitEffectIDs: []int{615}},
	SkillNJZenynage:                 {BeforeHitEffectIDs: []int{616}},
	SkillNJTatamigaeshi:             {GroundEffectIDs: []int{631}},
	SkillNJKasumikiri:               {EffectIDs: []int{632}},
	SkillNJKirikage:                 {EffectIDs: []int{630}},
	SkillNJBunsinjyutsu:             {EffectIDs: []int{617}},
	SkillNJKouenka:                  {EffectIDs: []int{618}},
	SkillNJKaensin:                  {GroundEffectIDs: []int{634}},
	SkillNJBakuenryu:                {EffectIDs: []int{635}},
	SkillNJHyousensou:               {EffectIDs: []int{619}},
	SkillNJSuiton:                   {GroundEffectIDs: []int{620}},
	SkillNJHyousyouraku:             {EffectIDs: []int{636}},
	SkillNJHuujin:                   {EffectIDs: []int{621}},
	SkillNJRaigekisai:               {EffectIDs: []int{622}},
	SkillNJIssen:                    {EffectIDs: []int{633}},
	SkillNPCEarthquake:              {EffectIDsOnCaster: []int{666}},
	SkillNPCFirebreath:              {HitEffectIDs: []int{49}},
	SkillNPCThunderbreath:           {HitEffectIDs: []int{52}},
	SkillNPCDragonfear:              {EffectIDs: []int{668}},
	SkillNPCPulsestrike:             {EffectIDsOnCaster: []int{409}},
	SkillNPCWidefreeze:              {EffectIDsOnCaster: []int{89}},
	SkillNPCWidebleeding:            {EffectIDsOnCaster: []int{669}},
	SkillNPCEvilland:                {GroundEffectIDs: []int{674}},
	SkillNPCCriticalwound:           {HitEffectIDs: []int{677}},
	SkillALLWewish:                  {EffectIDs: []int{717}},
	SkillNPCVenomfog:                {EffectIDs: []int{1020}},
	SkillCRShrink:                   {EffectIDs: []int{599}},
	SkillASVenomknife:               {BeforeHitEffectIDs: []int{600}},
	SkillRGCloseconfine:             {EffectIDs: []int{602}, GroundEffectIDs: []int{604}},
	SkillWZSightblaster:             {EffectIDs: []int{601}},
	SkillSAElementwater:             {EffectIDs: []int{256}},
	SkillHTPhantasmic:               {HitEffectIDs: []int{1}},
	SkillBaPangvoice:                {SuccessEffectIDs: []int{606}},
	SkillDCWinkcharm:                {SuccessEffectIDs: []int{607}},
	SkillMOBalkyoung:                {EffectIDs: []int{514}, HitEffectIDs: []int{effectHit3}},
	SkillSAElementground:            {EffectIDs: []int{258}},
	SkillSAElementfire:              {EffectIDs: []int{255}},
	SkillSAElementwind:              {EffectIDs: []int{257}},
	SkillRKEnchantblade:             {EffectIDs: []int{756}},
	SkillRKSonicwave:                {EffectIDs: []int{832}},
	SkillRKHundredspear:             {EffectIDs: []int{723}},
	SkillRKIgnitionbreak:            {EffectIDsOnCaster: []int{722}},
	SkillRKDragonbreath:             {HitEffectIDs: []int{587}},
	SkillRKDragonhowling:            {EffectIDs: []int{731}},
	SkillRKMillenniumshield:         {EffectIDs: []int{749}},
	SkillWLWhiteimprison:            {EffectIDs: []int{802}},
	SkillWLFrostmisty:               {EffectIDs: []int{726}},
	SkillWLJackfrost:                {GroundEffectIDs: []int{801}},
	SkillWLMarshofabyss:             {EffectIDs: []int{729}},
	SkillWLRecognizedspell:          {EffectIDs: []int{803}},
	SkillWLStasis:                   {EffectIDs: []int{799}},
	SkillWLCrimsonrock:              {EffectIDs: []int{727}},
	SkillWLHellinferno:              {EffectIDs: []int{800}, GroundEffectIDs: []int{728}},
	SkillWLChainlightningAtk:        {EffectIDs: []int{734}},
	SkillWLEarthstrain:              {GroundEffectIDs: []int{732}},
	SkillWLTetravortex:              {EffectIDs: []int{804}, BeginCastEffectIDs: []int{805}},
	SkillWLRelease:                  {EffectIDs: []int{751}},
	SkillGCVenomimpress:             {EffectIDs: []int{788}},
	SkillGCPoisonsmoke:              {EffectIDs: []int{924}},
	SkillGCRollingcutter:            {EffectIDs: []int{775}},
	SkillGCCrossripperslasher:       {EffectIDs: []int{769}},
	SkillABJudex:                    {EffectIDs: []int{718}, HitEffectIDs: []int{152}},
	SkillABAdoramus:                 {EffectIDs: []int{721}},
	SkillABCheal:                    {EffectIDs: []int{313}},
	SkillABEpiclesis:                {EffectIDs: []int{883}, GroundEffectIDs: []int{754}},
	SkillABOratio:                   {EffectIDs: []int{755}},
	SkillABHighnessheal:             {EffectIDs: []int{325}, HitEffectIDs: []int{320}},
	SkillABClearance:                {EffectIDs: []int{753}},
	SkillRAArrowstorm:               {EffectIDs: []int{746}},
	SkillRAAimedbolt:                {EffectIDs: []int{745}},
	SkillRADetonator:                {EffectIDs: []int{750}},
	...
	SkillNCPowerswing:               {EffectIDs: []int{795}},
	SkillSCBodypaint:                {EffectIDs: []int{811}},
	SkillSCEnervation:               {EffectIDs: []int{813}},
	SkillSCGroomy:                   {EffectIDs: []int{814}},
	SkillSCIgnorance:                {EffectIDs: []int{815}},
	SkillSCLaziness:                 {EffectIDs: []int{816}},
	SkillSCUnlucky:                  {EffectIDs: []int{817}},
	SkillSCWeakness:                 {EffectIDs: []int{818}},
	SkillSCStripaccessary:           {EffectIDs: []int{820}},
	SkillSCManhole:                  {GroundEffectIDs: []int{822}, SuccessEffectIDs: []int{823}},
	SkillSCDimensiondoor:            {GroundEffectIDs: []int{825}},
	SkillSCChaospanic:               {GroundEffectIDs: []int{827}},
	SkillSCMaelstrom:                {GroundEffectIDs: []int{828}},
	SkillSCBloodylust:               {GroundEffectIDs: []int{829}},
	SkillLGShieldpress:              {BeforeHitEffectIDs: []int{906}},
	SkillLGPrestige:                 {EffectIDs: []int{908}},
	SkillLGBanding:                  {EffectIDs: []int{909}},
	SkillLGInspiration:              {EffectIDs: []int{910}},
	SkillSREarthshaker:              {EffectIDs: []int{888}},
	SkillWmReverberation:            {GroundEffectIDs: []int{856}},
	SkillWmReverberationMelee:       {EffectIDs: []int{860}},
	SkillWmDominionImpulse:          {EffectIDs: []int{863}},
	SkillWmSevereRainstorm:          {EffectIDs: []int{857}},
	SkillWmPoemofnetherworld:        {GroundEffectIDs: []int{860}},
	SkillWmVoiceofsiren:             {GroundEffectIDs: []int{879}},
	SkillWmLullabyDeepsleep:         {EffectIDs: []int{858}},
	SkillWmSircleofnature:           {EffectIDs: []int{861}},
	SkillWmRandomizespell:           {EffectIDs: []int{862}},
	SkillWmGloomyday:                {EffectIDs: []int{847}},
	SkillWmSongOfMana:               {EffectIDsOnCaster: []int{865}, GroundEffectIDs: []int{868}},
	SkillWmDanceWithWug:             {EffectIDsOnCaster: []int{867}, GroundEffectIDs: []int{866}},
	SkillWmSaturdayNightFever:       {EffectIDsOnCaster: []int{871}, GroundEffectIDs: []int{870}},
	SkillWmLeradsDew:                {EffectIDsOnCaster: []int{871}, GroundEffectIDs: []int{872}},
	SkillWmMelodyofsink:             {EffectIDsOnCaster: []int{873}, GroundEffectIDs: []int{874}},
	SkillWmBeyondOfWarcry:           {EffectIDsOnCaster: []int{875}, GroundEffectIDs: []int{876}},
	SkillWmUnlimitedHummingVoice:    {EffectIDsOnCaster: []int{877}, GroundEffectIDs: []int{878}},
	SkillSOFirewalk:                 {GroundEffectIDs: []int{920}},
	SkillSOElectricwalk:             {GroundEffectIDs: []int{926}},
	SkillSOEarthgrave:               {EffectIDs: []int{927}},
	SkillSODiamonddust:              {EffectIDs: []int{928}},
	SkillSOPoisonBuster:             {EffectIDs: []int{923}},
	SkillSOPsychicWave:              {EffectIDs: []int{922}},
	SkillSOWarmer:                   {EffectIDs: []int{929}},
	SkillSOVacuumExtreme:            {EffectIDs: []int{921}},
	SkillSOVaretyrSpear:             {BeforeHitEffectIDs: []int{930}},
	...
	SkillGCDarkcrow:                 {EffectIDs: []int{1040}},
	SkillGNIllusiondoping:           {EffectIDs: []int{1049}},
	SkillRKLuxanima:                 {EffectIDs: []int{1044}},
	SkillNCMagmaEruption:            {EffectIDs: []int{1050}},
	SkillSOElementalShield:          {EffectIDs: []int{1046}},
	SkillSRFlashcombo:               {EffectIDs: []int{1043}},
	SkillABOffertorium:              {EffectIDs: []int{1047}},
	SkillWLTelekinesisIntense:       {EffectIDs: []int{1048}},
	SkillALLFullThrottle:            {EffectIDs: []int{1042}},
	SkillHlifChange:                 {EffectIDs: []int{505}},
	SkillHamiCastle:                 {EffectIDs: []int{570}},
	SkillHamiDefence:                {EffectIDs: []int{569}},
	SkillHamiBloodlust:              {EffectIDs: []int{571}},
