...
var SkillEffects = map[uint16]SkillEffectSpec{
	...
	SkillMOSteelbody:                {EffectIDs: []int{effectSteelBody}},
	SkillMOExplosionspirits:         {EffectIDsOnCaster: []int{effectGumgang2}, BeginCastEffectIDs: []int{12}},
	SkillMOExtremityfist:            {HitEffectIDs: []int{effectTeiHit1X}, BeginCastEffectIDs: []int{12}},
	...
	SkillBDDrumbattlefield:          {EffectIDs: []int{effectBottomDrum}},
	SkillBDRingnibelungen:           {EffectIDs: []int{effectBottomNibelung}},
	SkillBDRokisweil:                {EffectIDs: []int{effectBottomRoki}},
	SkillBDIntoabyss:                {EffectIDs: []int{effectBottomAbyss}},
	SkillBDSiegfried:                {EffectIDs: []int{effectBottomSieg}},
	SkillBaMusicalstrike:            {HideCastAura: true},
	SkillBaFrostjoke:                {BeginCastEffectIDs: []int{effectTalkFrostJoke}},
	SkillBaWhistle:                  {EffectIDs: []int{effectBottomWhistle}},
	SkillBaAssassincross:            {EffectIDs: []int{effectBottomSinX}},
	SkillBaPoembragi:                {EffectIDs: []int{effectBottomBragi}},
	SkillBaAppleidun:                {EffectIDs: []int{effectBottomApple}},
	SkillDCThrowarrow:               {HideCastAura: true},
	SkillDCScream:                   {BeginCastEffectIDs: []int{effectTalkScream}},
	SkillDCHumming:                  {EffectIDs: []int{effectBottomHumming}},
	SkillDCDontforgetme:             {EffectIDs: []int{effectBottomForget}},
	SkillDCFortunekiss:              {EffectIDs: []int{effectBottomFortune}},
	SkillDCServiceforyou:            {EffectIDs: []int{effectBottomService}},
	...
	SkillChTigerfist:                {EffectIDs: []int{377}, EffectIDsOnCaster: []int{effectGumgang3}},
